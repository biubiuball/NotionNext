      ...
      <div className='w-full lg:hover:shadow lg:border rounded-t-xl lg:rounded-xl lg:px-2 lg:py-4 
        ...
        {!lock && post && (
          <div className='overflow-x-auto flex-grow mx-auto md:w-full md:px-5 '>
            ...
            {/* 评论互动 */}
            <div className='duration-200 overflow-x-auto rounded-t-xl lg:rounded-xl backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-white/20 dark:bg-black/20 px-3'>
